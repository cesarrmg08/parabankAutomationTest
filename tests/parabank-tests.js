const { validateHomePage, goToParabankWebsite } = require('../pages/actions/home-page-actions')
const { validateAboutUsPage, clickAboutUsButton } = require('../pages/actions/about-us-actions')
const { validateServicesPage, clickServicesButton, scrollToRestFulServices } = require('../pages/actions/services-actions')
const { validateLoginLabel, clickLogInButton, fillPasswordField, fillUserNameField, validateInvalidLoginErrorMessage, validateEmptyFieldErrorMessage } = require('../pages/actions/login-actions')
const { clickPruductsButton, validateProductsPage, validateContactUsForm, clickContactUsButton } = require('../pages/actions/products-actions')
